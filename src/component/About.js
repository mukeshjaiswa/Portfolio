...
export default function About() {
  return (
   ...
   <h1 className='text-2xl font-bold text-center  '>ABOUT ME</h1>
    <div className=' border border-transparent bg-[#2C2C6C] hover:bg-transparent hover:border-[#4db5ff] mt-3  h-auto p-3 mb-20 w-[70%] sm:w-[70%] flex flex-col  items-center justify-center  sm:flex-col text-white rounded-3xl   mx-auto  '  >
