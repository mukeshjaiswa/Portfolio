    ...
    return (
        <div className='w-[100%] h-[80vh] mt-20 text-white flex flex-col justify-center items-center' id='#home'>
            ...
            <div className='w-[600px] mx-auto sm:w-[900px]  flex-wrap flex justify-center items-center '>
                <div className=' border w-[80%] sm:w-[40%] sm:gap-4  rounded-3xl mx-10   p-6 flex flex-col shadow-2xl  hover:bg-transparent items-center border-transparent hover:border-[#4db5ff] ' data-aos="fade-right"
                ...
                <div className='h-[300px] w-[300px] mr-10  rounded-3xl bg-[#4db5ff]  flex items-center justify-center mt-10 sm:mt-0 sm:ml-20' data-aos="fade-left"
                    data-aos-duration="1000">
                    <img src="/mukesh.jpg" className='h-[295px] w-[295px]    rounded-3xl -rotate-3 hover:-rotate-6' alt="" />
                </div>
            </div>
        </div>
