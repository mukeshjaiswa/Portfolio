...
export default function Home() {
    ...
    return (
        ...
        <div className='w-[600px] mx-auto sm:w-[900px]  flex-wrap flex justify-center items-center '>
            <div className=' border shadow-customShadow w-[80%] sm:w-[40%] sm:gap-4 border-2 rounded-md mx-10  bg-bgdark border-customYellow p-6 flex flex-col items-center '  data-aos="fade-right"
        data-aos-duration="1000">
                <h1 className='text-3xl font-bold text-white ' ref={typeRef}></h1>
                <a href='/pdf/cv.pdf' download='CV.pdf' className='border  border-2 border-black bg-white text-black py-2 px-6 rounded-md hover:bg-black hover:text-white hover:border-b-2 hover:border-customYellow font-bold' >DownLoad CV</a>
            </div>
        ...
        data-aos-duration="1000">
                <img src="download.jpeg" className='h-[295px] w-[295px]    rounded-full' alt="" />
            </div>
        </div>
        </div>
